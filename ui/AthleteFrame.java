...
public class AthleteFrame extends ChildWindow implements ActionListener {      //κανει extend το childwindow ωστε να μπορει να επιστρεφει στο προηγουμενο παραθυρο
	...
	public AthleteFrame(JFrame parentWindow, AthleteService athleteService) {         //το parent window το καλει ωστε να μπορει να επιστρεψει πισω
		super(parentWindow);              //το κληρωνομει
		this.addAthleteFrame = new AddAthleteFrame(this, athleteService);        //φτιαχνει τα αναλογα αντικειμενα των υπολοιπων frames
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if (e.getSource() == registrationPayment) {         //αν πατηθει το αναλογο κουμπι να κανει ωρατη την πληρωμη εγραφης
